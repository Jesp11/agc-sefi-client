...
export default function ConfirmacionMovimientosPage() {
  ...
  const [reprogramando, setReprogramando] = useState<any | null>(null);
  ...
  const resolver = async (movimiento: any, accion: "confirmar" | "cancelar" | "confirmar-reintegro" | "reprogramar-desembolso", fechaNueva?: string) => {
  ...
  return <div className="space-y-6">
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      <div><h1 className="text-3xl font-bold">Confirmación de Movimientos</h1><p className="text-muted-foreground">Seguimiento diario de egresos, entregas y reintegros de renovaciones.</p></div>
