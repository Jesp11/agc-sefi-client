...
export default function ReporteAhorrosSociosPage() {
  const [data, setData] = useState<any>(null);
  const [anio, setAnio] = useState(new Date().getFullYear());

  useEffect(() => {
    apiFetch(`/reportes/ahorros-socios?anio=${anio}`).then(async (res) => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap justify-between items-center gap-4">
        <h1 className="text-3xl font-bold">Reporte Ahorro de Socios</h1>
