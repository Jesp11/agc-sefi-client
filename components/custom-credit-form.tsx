            ...
            {selectedOption && (
              <div className="grid grid-cols-2 gap-3 rounded-lg border p-3">
                ...
                <div className="text-right text-xs space-y-1 self-end">
                  <p className="text-muted-foreground">Pago semanal <span className="font-semibold text-foreground">${Number(selectedOption.pago_semanal).toLocaleString()}</span></p>
                  <p className="text-muted-foreground">Interés <span className="font-semibold text-foreground">${Number(selectedOption.interes_total).toLocaleString()}</span></p>
                  <p className="text-muted-foreground">Total <span className="font-semibold text-foreground">${Number(selectedOption.total_a_pagar).toLocaleString()}</span></p>
                </div>
              </div>
            )}
