...
const STATIC_NAVIGATION_ITEMS: Omit<SearchItem, "onClick">[] = [
  ...
  {
    id: "nav-rep-global-cobros",
    type: "module",
    title: "Reporte Global Cobros",
    subtitle: "Cobros semanales y mensuales por día y asesor",
    category: "Reportes",
    url: "/dashboard/reportes/global-cobros",
    icon: FileText,
    keywords: ["reporte", "global", "cobros", "mensual", "semanal", "asesor", "gestor", "abonos", "multas"],
  },
  {
