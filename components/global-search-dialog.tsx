...
const STATIC_NAVIGATION_ITEMS: Omit<SearchItem, "onClick">[] = [
  ...
  },
  {
    id: "nav-rep-semanal",
    type: "module",
    title: "Global Semanal",
    subtitle: "Resumen operativo semanal y balance de colocación",
    category: "Reportes",
    url: "/dashboard/reportes/semanal",
    icon: FileText,
    keywords: ["reporte", "semanal", "global", "semana", "balance", "resumen"],
  },
  {
    id: "nav-rep-asesor-mora",
    type: "module",
    title: "Mora por Asesor",
    subtitle: "Índice y desglose de cartera vencida por cada asesor",
    category: "Reportes",
    url: "/dashboard/reportes/asesor-mora",
    icon: AlertTriangle,
    keywords: ["mora", "asesor", "cartera", "vencida", "morosidad", "desglose"],
  },
  {
    id: "nav-rep-por-cerrar",
    type: "module",
    title: "Clientes por Cerrar",
    subtitle: "Créditos en sus últimas cuotas listos para liquidación o renovación",
    category: "Reportes",
    url: "/dashboard/reportes/por-cerrar",
    icon: UserX,
    keywords: ["por cerrar", "liquidar", "ultimos pagos", "terminando", "renovacion"],
  },
  {
    id: "nav-rep-sin-renovacion",
    type: "module",
    title: "Clientes Sin Renovación",
    subtitle: "Clientes liquidados que aún no renuevan préstamo",
    category: "Reportes",
    url: "/dashboard/reportes/clientes-sin-renovacion",
    icon: UserX,
    keywords: ["sin renovacion", "cerrados", "reactivacion", "clientes perdidos"],
  },
  {
  ...
  {
    id: "nav-rep-inversionistas",
    type: "module",
    title: "Reporte de Inversionistas",
    subtitle: "Rendimientos acumulados e intereses por pagar",
    category: "Reportes",
    url: "/dashboard/reportes/inversionistas",
    icon: TrendingUp,
    keywords: ["reporte", "inversionistas", "rendimientos", "intereses"],
    adminOnly: true,
  },
  {
    id: "nav-rep-inversionistas-estado",
    type: "module",
    title: "Estado Financiero Inversionistas",
  ...
  {
    id: "nav-rep-cartera-ahorro",
    type: "module",
    title: "Reporte Cartera de Ahorro",
    subtitle: "Saldos totales en fondos de ahorro",
    category: "Reportes",
    url: "/dashboard/reportes/cartera-ahorro",
    icon: PiggyBank,
    keywords: ["cartera ahorro", "fondos", "totales"],
    adminOnly: true,
  },
  {
    id: "nav-rep-gastos",
    ...
    subtitle: "Consolidado de gastos por rubro y categoría",
    category: "Reportes",
    url: "/dashboard/reportes/gastos-operativos",
    icon: Receipt,
    keywords: ["reporte gastos", "rubros", "operativos"],
    adminOnly: true,
  },
  {
    id: "nav-rep-comparativas",
    type: "module",
    title: "Comparativas y Estadísticas",
    subtitle: "Comparativas de crecimiento y cobranza entre periodos",
    category: "Reportes",
    url: "/dashboard/reportes/comparativas",
    icon: BarChart3,
    keywords: ["comparativas", "graficas", "estadisticas", "crecimiento"],
    adminOnly: true,
  },
